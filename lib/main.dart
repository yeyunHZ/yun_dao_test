...
import 'package:yun_dao_test/student_entity.dao.dart';
...
class _MyHomePageState extends State<MyHomePage> {
        ...
        child: Column(
          ...
          children: <Widget>[
            GestureDetector(
              ...
              onTap: () {
                StudentEntityDao.insert(StudentEntity(name: "张三", age: 1));
                StudentEntityDao.insert(StudentEntity(name: "李四", age: 2));
                StudentEntityDao.insert(StudentEntity(name: "李四", age: 3));
                _query();
              },
            ),
            Text(
  ...
  void _query() async {
    List list = await StudentEntityDao.queryBuild()
        ...
        .list();
    print("找到" + list.length.toString() + "条数据");
  }
}
